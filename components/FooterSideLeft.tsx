...
function FooterSideLeft({}: Props) {
  return (
    <div className="pb-10 sm:pb-0 sm:pr-3 sm:min-h-48 sm:min-w-[23rem] flex flex-col space-y-6 sm:space-y-10 sm:border-r-4 border-b-4 sm:border-b-0 border-dashed border-orange-300">
        <h1 className="text-2xl sm:text-[1.75rem] leading-7 sm:leading-8 font-black">Ending global poverty with the art of caring </h1>
        ...
        <div className="flex flex-col space-y-3">
            <div className="flex items-center space-x-2">
                ...
                <span className="underline">adehye.charity@gmail.com</span>
            </div>
            <div className="flex items-center space-x-3">
                <FaPhone className="h-4 w-4 sm:h-5 sm:w-5" />
                <span className="underline">44-000-000-0000</span>
            </div>
        </div>
    </div>
  )
